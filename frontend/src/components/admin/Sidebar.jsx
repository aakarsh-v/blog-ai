  ...
  return (
    <div className='flex flex-col border-r border-gray-200 min-h-full pt-6'>
        ...
        "bg-primary/10 border-r-4 border-primary"}`}>
            ...
            <p classname='hidden md:inline-block>Dashboard'>Dashboard</p>
        </NavLink>
        ...
        "bg-primary/10 border-r-4 border-primary"}`}>
            ...
            <p classname='hidden md:inline-block>Dashboard'>Add blogs</p>
        </NavLink>
        ...
        "bg-primary/10 border-r-4 border-primary"}`}>
            ...
            <p classname='hidden md:inline-block>Dashboard'>Blog Lists</p>
        </NavLink>
        ...
        "bg-primary/10 border-r-4 border-primary"}`}>
            ...
            <p classname='hidden md:inline-block>Dashboard'>Comments</p>
        </NavLink>
    </div>
  )
}
